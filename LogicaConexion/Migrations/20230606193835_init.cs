        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CabanaNumeroHabitacion = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Mantenimientos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Mantenimientos_Cabanas_CabanaNumeroHabitacion",
                        column: x => x.CabanaNumeroHabitacion,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Mantenimientos_CabanaNumeroHabitacion",
                table: "Mantenimientos",
                column: "CabanaNumeroHabitacion");
